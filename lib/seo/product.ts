...
export function answersFor(p: Product): QA[] {
  ...
  return [
    ...
    },
    {
      ...
      a: `Επίσημη εγγύηση αντιπροσωπείας 2 ετών, με δυνατότητα επέκτασης έως 5 έτη από 19 €. Δικαίωμα υπαναχώρησης 14 ημερών χωρίς αιτιολογία και δωρεάν επιστροφή σε οποιοδήποτε από τα 350 καταστήματα Euronics. Service με γνήσια ανταλλακτικά${p.isRenew ? ". Ως προϊόν Renew, είναι ελεγμένο και ανακατασκευασμένο με εγγύηση Euronics" : ""}.`,
    },
    {
