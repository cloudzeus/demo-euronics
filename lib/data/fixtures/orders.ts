...
export const orders: Order[] = [
  {
    ...
    address: demoAddress,
    lines: [
      { productId: "p-lg-43nano82", title: "43NANO82T6B NanoCell 43\" 4K Smart TV", brand: "LG", image: "/img/products/p-lg-43nano82-0.jpg", qty: 1, unitPrice: 349, addons: [{ slug: "epektasi-eggyisis", title: "Επέκταση εγγύησης 5 έτη", price: 39 }] },
      { productId: "p-jbl-flip-7", title: "Flip 7 Φορητό Ηχείο Bluetooth", brand: "JBL", image: "/img/products/speaker.jpg", qty: 1, unitPrice: 129 },
    ],
    subtotal: 517,
    shippingFee: 0,
    total: 517,
  ...
  },
  {
    ...
    lines: [{ productId: "p-philips-airfryer", title: "Airfryer XXL HD9285 7,2 L", brand: "PHILIPS", image: "/img/products/airfryer.jpg", qty: 1, unitPrice: 179 }],
    subtotal: 179,
    shippingFee: 0,
    total: 179,
