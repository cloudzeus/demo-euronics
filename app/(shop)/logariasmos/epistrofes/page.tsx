...
export default async function ReturnsPage({ searchParams }: { searchParams: Promise<{ order?: string }> }) {
  ...
  return (
    <div className="grid gap-4">
      ...
      <p className="m-0 text-eu-ink-2 text-[length:var(--fs-13)]">14 ημερολογιακές ημέρες από την παραλαβή. Επιλέγεις παραγγελία, προϊόντα και λόγο· λαμβάνεις κωδικό RMA και οδηγίες.</p>
