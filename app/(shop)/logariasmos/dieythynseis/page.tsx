  ...
  return (
    <div className="grid gap-4">
      ...
      <ul className="m-0 p-0 list-none grid grid-cols-1 @md:grid-cols-2 gap-3">
        <li className="bg-white rounded-xl border-2 border-eu-blue p-4 text-[length:var(--fs-15)]">
          <div className="flex justify-between items-center mb-1">
            <span className="font-extrabold text-eu-ink">{a.label}</span>
            <span className="rounded-full bg-eu-chip text-eu-blue font-bold text-[length:var(--fs-13)] px-2 py-0.5">Προεπιλογή</span>
          </div>
          ...
          <div className="flex gap-3 mt-3 text-[length:var(--fs-14)] font-bold">
