  ...
  return (
    ...
    >
      ...
      <fieldset className="m-0 p-0 border-0 grid gap-1.5">
        <legend className="font-semibold text-eu-ink text-[length:var(--fs-14)] mb-1">Προϊόντα προς επιστροφή</legend>
        {o?.lines.map((l) => (
      ...
      <label className={label}>
        Σχόλια <textarea rows={3} className="rounded-md border border-eu-line bg-white px-3 py-2 text-[length:var(--fs-15)]" />
      </label>
