...
export function BentoHero({ slides, deal, store, services, intervalMs, zoneNo }: Props) {
  return (
    <section className="relative bg-eu-navy eu-container" aria-label="Προτεινόμενα">
      <ZoneBadge no={zoneNo} />
      <div className="eu-canvas p-3 @lg:p-3.5 grid grid-cols-1 @md:grid-cols-2 @lg:grid-cols-[2fr_1fr] @lg:grid-rows-[auto_auto] gap-3 @lg:gap-3.5">
        <div className="@md:col-span-2 @lg:col-span-1 @lg:row-span-2">
          <HeroSlider slides={slides} intervalMs={intervalMs} />
        </div>
