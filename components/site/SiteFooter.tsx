...
const cols: { title: string; links: { label: string; href: string }[] }[] = [
  ...
  { title: "Η Euronics", links: [{ label: "Ποιοι είμαστε", href: "/etaireia" }, { label: "Όλες οι υπηρεσίες", href: "/ypiresies" }, { label: "Δίκτυο καταστημάτων", href: "/katastimata" }, { label: "Μάρκες", href: "/brands" }, { label: "Έξυπνος οδηγός αγοράς", href: "/odigos-agoras" }, { label: "Οδηγοί & blog", href: "/odigoi" }, { label: "Οικονομικά στοιχεία", href: "/etaireia#oikonomika" }] },
